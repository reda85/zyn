...
import { Menu, BarChart3, TrendingUp, ShieldCheck, FileText, Settings, Sparkles, ArrowRight } from "lucide-react"
      ...
      <main className="pt-32 pb-16">
        ...
        <section className="px-6 mb-32 relative">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl -z-10 pointer-events-none">
            ...
            <div className="absolute top-0 right-1/4 w-96 h-96 bg-secondary/20 rounded-full blur-3xl mix-blend-multiply animate-blob animation-delay-2000"></div>
          </div>

          <div className="max-w-5xl mx-auto text-center">
            {/* Badge */}
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-secondary/50 border border-border/50 text-secondary-foreground text-xs font-medium mb-8 animate-in fade-in zoom-in-95 duration-500 ease-out backdrop-blur-sm">
            ...
            {/* Titre */}
            <h1 className="text-5xl md:text-7xl font-bold font-heading tracking-tight mb-8 text-foreground leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150 ease-out">
              Le suivi de chantier, <br className="hidden md:block" />
              <span className="text-muted-foreground">en toute simplicité.</span>
            </h1>

            {/* Paragraphe */}
            <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 ease-out fill-mode-backwards">
            ...
            {/* Boutons */}
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 ease-out fill-mode-backwards">
            ...
            <p className="mt-6 text-sm text-muted-foreground animate-in fade-in duration-1000 delay-700">
