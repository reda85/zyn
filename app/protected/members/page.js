    ...
    <div className={clsx("flex min-h-screen ", lexend.className)}>
      ...
      <aside className="w-52 bg-neutral-50 text-stone-600 flex flex-col">
        ...
        <nav className="flex-1 px-4 space-y-1">
          <Link href="/protected/projects" className="flex text-sm items-center gap-3 px-4 py-2 hover:bg-blue-50 hover:text-stone-800 hover:rounded-lg hover:shadow-sm border-2 border-neutral-50 hover:border-blue-200   ">
            <FolderKanban className="w-5 h-5" /> Projects
          </Link>
          <Link href="/protected/members" className="flex text-sm items-center gap-3 px-4 py-2 bg-blue-100 text-stone-800 rounded-lg shadow-sm border-blue-300  ">
